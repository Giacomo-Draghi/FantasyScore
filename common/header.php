                ...
                <?php 
                    ...
                    //check if the user is logged in
                        if (isset($_SESSION['loggedin'])){
                            ...
                            echo "<a href='/phpmotors/accounts' title='User info' id='userW'>Welcome $clientFname $clientLname</a>";
                        };
                ?>
                <?php
                    if (isset($_SESSION['loggedin'])){
                        echo"<a href='/phpmotors/accounts?action=login-out' title='Log Out PHP Motors' id='acc'>Log Out</a>";
                    }
                    else{
